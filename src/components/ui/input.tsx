...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  return (
    <div className="w-full">
      ...
      <div
        className={cn(
          "flex min-h-12 items-center gap-3 rounded-3xl border border-white/[0.1] bg-white/[0.04] px-4 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)] backdrop-blur-md transition-[box-shadow,border-color] duration-200 ease-out hover:border-white/[0.14]",

                  ...
                  {items.map((tx) => (
                    <li key={tx.id}>
                      <GlassCard
                        padding="md"
                        glow="none"
                        className="relative ml-2 border-white/[0.08] transition hover:border-teal-400/20 hover:shadow-[0_0_28px_-12px_rgba(45,212,191,0.15)] sm:ml-4"
                      >
                          ...
                          <div className="min-w-0 flex-1 space-y-2">
                            <div className="flex flex-wrap items-center gap-2">
                              <Link
                                ...
                                className="truncate text-base font-semibold text-white hover:text-teal-200"
                              >
                                {tx.title}
                              </Link>
                          ...
                          <div className="flex shrink-0 flex-col items-end gap-3 sm:flex-row sm:items-center">
                            ...
                            <div className="flex gap-1">
                              <Link
                                href={`/transactions/${tx.id}`}
                                className={cn(
                                  "inline-flex h-9 w-9 items-center justify-center rounded-2xl bg-transparent text-slate-200 ring-1 ring-white/10 transition hover:bg-white/[0.1]",
